            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 py-2">
                {processedVersiones.map((event) => (
                    typeof container === "function" ? (
                        <Card
                            key={event.id}
                            className="h-full border-2 transition-all duration-200 ease-in-out transform"
                        >
                    ...
                    >
                        <Card
                                className="h-full border-2 transition-all duration-200 ease-in-out transform hover:scale-105 hover:text-primary hover:border-primary"
                        >
                            <CardHeader className="flex justify-between items-center">
                                    <CardTitle className="text-xl truncate" title={event.nombre}>
                                    {event.nombre}
